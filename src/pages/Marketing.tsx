...
import { ingestKnowledge, saveMarketingPlan, sendMarketingMessage } from "@/utils/api";
...
const Marketing = () => {
  ...
  const ask = async (text: string) => {
    ...
    try {
      ...
      setMessages((current) => [...current, { role: "assistant", text: result.response || "I could not generate a strategy for that request. Please try again." }]);
    }
    catch (error) {
